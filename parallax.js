...
var wf_pbb_controller = {
    ...
    appendPreloader: function () {
        ...
        prl.innerHTML = "Loading the awesome...";
        ...
        if (navigator.appVersion.indexOf("Mobile") == -1) {
            ...
            $('body').on( "mouseleave", function() {
                for (i = 1; i < wf_pbb_object.length; i++) {
                    ...
                    me.style.backgroundPosition = 0 + "px " + 0 + "px";
                }
            });
            document.onmousemove = function (e) {
                ...
                for (i = 1; i < wf_pbb_object.length; i++) {
                    if (wf_pbb_object[i].mm) {
                        ...
                        curPos = curPos.split(" ");
                        var pos = {
                            //newX: parseInt(curPos[0].substr(0, curPos[0].length - 2)) + speed * wf_pbb_controller.dir.x * 1,
                            newX: parseInt(curPos[0].substr(0, curPos[0].length - 2)) + speed * wf_pbb_controller.dir.x,
                            newY: parseInt(curPos[1].substr(0, curPos[1].length - 2)) + speed * wf_pbb_controller.dir.y 
                        }
